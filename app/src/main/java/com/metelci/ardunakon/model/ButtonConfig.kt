...
data class ButtonConfig(
    val id: Int,
    val label: String,
    // Custom command override, or default ID
    val command: String,
    // Default Blue
...
val defaultButtonConfigs = listOf(
    // Pastel Blue
    ButtonConfig(1, "Aux 1", "1", 0xFF90CAF9),
    // Pastel Green
    ButtonConfig(2, "Aux 2", "2", 0xFFA5D6A7),
    // Pastel Orange
    ButtonConfig(3, "Aux 3", "3", 0xFFFFCC80),
    // Pastel Purple
    ButtonConfig(4, "Aux 4", "4", 0xFFCE93D8)
)
