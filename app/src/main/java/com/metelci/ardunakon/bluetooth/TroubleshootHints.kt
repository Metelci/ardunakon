...
object TroubleshootHints {
    ...
    private val hints = listOf(
        // Connection errors
        Hint("socket", "Bağlantı soketi oluşturulamadı", "Bluetooth eşleştirmesini kontrol edin ve cihazı yeniden başlatın"),
        ...
        Hint("characteristic", "BLE özelliği bulunamadı", "Arduino sketch'inin doğru UUID'leri kullandığını doğrulayın"),
        ...
        Hint("BLUETOOTH", "Bluetooth izni eksik", "Ayarlar > Uygulamalar > Ardunakon > İzinler'den Bluetooth'u etkinleştirin"),
     ...
     */
    fun formatHint(explanation: String, solution: String): String {
