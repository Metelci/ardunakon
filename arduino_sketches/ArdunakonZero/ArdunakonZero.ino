/*
 * Ardunakon - Arduino Zero / M0 Sketch
 *
 * Full support for Arduino Zero, M0, M0 Pro (SAMD21 ARM Cortex-M0+)
 * Designed for use with the Ardunakon Android Controller App
 *
 * ⚠️ WARNING: 3.3V LOGIC LEVEL ONLY ⚠️
 * DO NOT CONNECT 5V SIGNAL TO RX PIN! The SAMD21 will be damaged.
 * Use a logic level converter or a 3.3V Bluetooth module.
 *
 * Board: Arduino Zero / M0
...
void setup() {
  ...
  // SAMD21 ADC setup (default 10-bit read)
  ...
  Serial.println("Arduino Zero/M0 - Ardunakon Controller");
